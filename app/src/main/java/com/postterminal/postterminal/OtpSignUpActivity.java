...
public class OtpSignUpActivity extends AppCompatActivity {
    ...
    public static String access_tok_signUp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnOtp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OtpCode otp = new OtpCode(number1,"signup",sms);
                    ...
                    public void onResponse(Call< OtpCode > call, Response< OtpCode > response) {
                       ...
                       // Log.d("errorCode", result_code + "   \n     ");
                        ...
                        /*if (resource != null) {*/
                            ...
                            access_tok_signUp = access_token;
                            ...
                            if (response.isSuccessful() && result_type.equals("1") && !access_token.isEmpty() && !refresh_token.isEmpty()) {
                                ...
                                startActivity(new Intent(OtpSignUpActivity.this, SignUpActivity.class));
                                Toast.makeText(getApplicationContext(), "Придумайте Pin-Code пожалуйста", Toast.LENGTH_LONG).show();
                            }
        ...
        btnSendsms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(120000, 1000){
                    ...
                    public void onTick(long millisUntilFinished){
                        btnSendsms.setEnabled(false);
                        timer.setText(String.valueOf(120 + 120-counter) + " сек.");
                        counter++;
                    }
                    public  void onFinish(){
                        timer.setText("Вы можете получить смс ещё раз");
                ...
                SendSmS SmS = new SendSmS(number1,"signup");
                ...
                call.enqueue(new Callback< SendSmS >() {
                    ...
                    public void onResponse(Call< SendSmS > call, Response< SendSmS > response) {
                        ...
                        if (response.isSuccessful() && result_code.equals("signup") && sign_type.equals("1") && !auth_token.isEmpty()){
                            Toast.makeText(getApplicationContext(),"Сообщение отправлено подождите.", Toast.LENGTH_LONG).show();
                        }
                        if (response.isSuccessful() && result_code.equals("signup") && sign_type.equals("0") && !auth_token.isEmpty()){
